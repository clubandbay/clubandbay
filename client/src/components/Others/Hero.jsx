...
const Hero = ({HomeHero, MenuHero, AboutHero, ContactHero, FAQHero, SubscriptionHero}) => {
  const heroContent = HomeHero || MenuHero || AboutHero || ContactHero || FAQHero || SubscriptionHero;
  return (
