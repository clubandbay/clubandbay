...
import { FaArrowRight, FaHamburger, FaPizzaSlice, FaIceCream, FaFish } from 'react-icons/fa';
import { GiChickenLeg, GiSushis } from 'react-icons/gi';
import Logo from '../../assets/pnglogo.png'
import Burger from '../../assets/burgerbg.png'
import Meal from '../../assets/pngmeal.png'
import FrenchFries from '../../assets/frenchfries.png'
import Salad from '../../assets/pngsalad.png'
import Roll from '../../assets/pngroll.png'
  ...
  return (
    <section className="relative !py-28 md:!py-36 lg:!pb-44 lg:!pt-20 menuhero_bg overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        >
          <img src={Burger} className='w-40 h-40' alt="Food" />
        </motion.div>
        ...
        >
          <img src={Meal} className='w-72 h-72' alt="Food" />
        </motion.div>
        ...
        >
          <img src={Salad}  className='w-52 h-52 hidden md:block' alt="Food" />
        </motion.div>
        ...
        >
          <img src={FrenchFries}  className='w-52 h-52' alt="Food" />
        </motion.div>
        ...
        >
          <img src={Roll}  className='w-52 h-52 hidden md:block' alt="Food" />
        </motion.div>
      </div>
      ...
      <div className="container !mx-auto !px-4 relative z-10">
        ...
        >
          <div className="w-52 h-40 shadow-2xl">
        ...
        >
          Our <span className="text-[#e7b745]">Delicious</span> Menu
        </motion.h1>
        ...
        >
          Crafted with passion using the freshest ingredients to delight your taste buds
        </motion.p>
        ...
        >
          <motion.button
            whileHover={{ scale: 1.05, backgroundColor: "#e7b745", color: "#0b3171" }}
            whileTap={{ scale: 0.95 }}
            className="bg-white text-[#0b3171] !px-8 !py-4 md:!px-10 md:!py-5 rounded-full font-bold text-lg md:text-xl flex items-center shadow-xl hover:shadow-2xl transition-all duration-300"
          >
            Explore Menu <FaArrowRight className="!ml-3" />
          </motion.button>
        </motion.div>
      </div>
